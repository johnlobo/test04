...
Hexadecimal [16-Bits]
                             ...
                             33 .globl _sp_palette
                             34 .globl _sp_upPills_0
                             35 .globl _sp_upPills_1
                             36 .globl _sp_upPills_2
                             37 .globl _sp_downPills_0
                             38 .globl _sp_downPills_1
                             39 .globl _sp_downPills_2
                             40 .globl _sp_leftPills_0
                             41 .globl _sp_leftPills_1
                             42 .globl _sp_leftPills_2
                             43 .globl _sp_rightPills_0
                             44 .globl _sp_rightPills_1
                             45 .globl _sp_rightPills_2
                             46 .globl _sp_blocks_0
                             47 .globl _sp_blocks_1
                             48 .globl _sp_blocks_2
...
Hexadecimal [16-Bits]
                     ...
                     00C8    34 max_Y = 200
                             ...
                             48 
                             49 ;;
                             50 ;; Macro: struct Player
                             51 ;;    Macro that creates a new initialized instance of Player Struct
                             52 ;; 
                             53 ;; Parameters:
                             54 ;;    instanceName: name of the variable that will be created as an instance of Player struct
                             55 ;;    st:           status of the player
                             56 ;;    x:            X location of the Entity (bytes)
                             57 ;;    y:            Y location of the Entity (pixels)
                             58 ;;    px:           Prevoius X location of the Entity (bytes)
                             59 ;;    py:           Previous Y location of the Entity (pixels)
                             60 ;;    wi:           Width of the Player Sprite (bytes)
                             61 ;;    he:           Height of the Player Sprite (bytes)
                             62 ;;    sp:       Pointer to the player sprite
                             63 ;;
                             64 .macro defineEntity name, st, x, y, px, py wi, he, sp
                             65    ;; Struct data
                             66    name:
                             67       .db st     ;; Status of the Player
                             68       .db x     ;; X location of the Player (bytes)
                             69       .db y     ;; Y location of the Player (pixels)
                             70       .db px     ;; X location of the Player (bytes)
                             71       .db py     ;; Y location of the Player (pixels)
                             72       .db wi     ;; Width of the Player Sprite (bytes)
                             73       .db he     ;; Height of the Player Sprite (bytes)
                             74       .dw sp ;; Pointer to the player sprite
                             75 .endm
                             76 ;; Entinty Offset constants
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 52.
Hexadecimal [16-Bits]



                     0000    77 e_status = 0  ;; Status byte: bit7: moved
                     0001    78 e_x = 1
                     0002    79 e_y = 2
                     0003    80 e_px = 3
                     0004    81 e_py = 4
                     ...
                     0007    84 e_sprite = 7
                             85 
                             86 ;; Define Entity Player
   414B                      87 defineEntity player, 0, 58, 60, 58, 60, blocks_width, blocks_height, #_sp_blocks_0
                              1    ;; Struct data
   0000                       2    player:
   414B 00                    3       .db 0     ;; Status of the Player
   414C 3A                    4       .db 58     ;; X location of the Player (bytes)
   414D 3C                    5       .db 60     ;; Y location of the Player (pixels)
   414E 3A                    6       .db 58     ;; X location of the Player (bytes)
   414F 3C                    7       .db 60     ;; Y location of the Player (pixels)
   4150 03                    8       .db blocks_width     ;; Width of the Player Sprite (bytes)
   4151 07                    9       .db blocks_height     ;; Height of the Player Sprite (bytes)
   4152 00 40                10       .dw #_sp_blocks_0 ;; Pointer to the player sprite
                             88 
                             89 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             90 ;;  FUNC: _move_entity_right
                             91 ;;  INPUT: IX pointer to the entity
                             92 ;;  OUTPUT:
                             93 ;;  DESTROYS: A
   4154                      94 _move_entity_right:
   4154 DD 7E 01      [19]   95     ld a, e_x(ix)
                             96     ;; check screen border
   4157 FE 4D         [ 7]   97     cp #(screen_max_X - blocks_width)
   4159 CA 68 41      [10]   98     jp z, no_move_right
   415C 3C            [ 4]   99     inc a
   415D DD 77 01      [19]  100     ld e_x(ix), a
                            101     ;; Update status
   4160 DD 7E 00      [19]  102     ld a, e_status(ix)      ;; Load status byte into A
   4163 F6 80         [ 7]  103     or #0b10000000       ;; Set active bit of entity to 1
   4165 DD 77 00      [19]  104     ld e_status(ix),a       ;; load back the state byte in the entity
   4168                     105 no_move_right:    
   4168 C9            [10]  106     ret
                            107 
                            108 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            109 ;;  FUNC: _move_entity_left
                            110 ;;  INPUT: IX pointer to the entity
                            111 ;;  OUTPUT:
                            112 ;;  DESTROYS: A
   4169                     113 _move_entity_left:
   4169 DD 7E 01      [19]  114     ld a, e_x(ix)
                            115     ;; check screen border
   416C B7            [ 4]  116     or a
   416D CA 7C 41      [10]  117     jp z, no_move_left
   4170 3D            [ 4]  118     dec a
   4171 DD 77 01      [19]  119     ld e_x(ix), a
                            120     ;; Update status
   4174 DD 7E 00      [19]  121     ld a, e_status(ix)      ;; Load status byte into A
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 53.
Hexadecimal [16-Bits]



   4177 F6 80         [ 7]  122     or #0b10000000       ;; Set active bit of entity to 1
   4179 DD 77 00      [19]  123     ld e_status(ix),a       ;; load back the state byte in the entity
   417C                     124 no_move_left:
   417C C9            [10]  125     ret
                            126 
                            127 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            128 ;;  FUNC: _draw_entity
                            129 ;;  INPUT: IX pointer to the entity
                            130 ;;  OUTPUT:
                            131 ;;  DESTROYS: AF, BC, DE, HL
   417D                     132 _draw_entity:
                            133    ;; Calculate a video-memory location for drawing the entity
   417D 11 00 C0      [10]  134    ld   de, #CPCT_VMEM_START_ASM    ;; DE = Pointer to start of the screen
   4180 DD 46 02      [19]  135    ld   b, e_y(ix)                      ;; B = y coordinate 
   4183 DD 4E 01      [19]  136    ld   c, e_x(ix)                      ;; C = x coordinate 
                            137 
   4186 CD 63 43      [17]  138    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            139    
                            140    ;; Draw Sprite
   4189 EB            [ 4]  141    ex  de, hl                       ;; DE = Pointer to Video Memory (X,Y) location
   418A DD 66 08      [19]  142    ld   h, e_sprite + 1(ix)    ;; | HL = Pointer to Player Sprite
   418D DD 6E 07      [19]  143    ld   l, e_sprite + 0(ix)    ;; |
   4190 DD 46 05      [19]  144    ld   b, e_width(ix)         ;; B = Player Width (bytes)
   4193 DD 4E 06      [19]  145    ld   c, e_height(ix)        ;; C = Player Height (pixels)
   4196 CD 3B 43      [17]  146    call cpct_drawSpriteBlended_asm         ;; Draw the sprite
   4199 C9            [10]  147 ret
                            148 
                            149 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            150 ;;  FUNC: _update_entity
                            151 ;;  INPUT: IX pointer to the entity
                            152 ;;  OUTPUT:
                            153 ;;  DESTROYS: AF, BC, DE, HL
   419A                     154 _update_entity:
                            155     ;; Erase Sprite
                            156    ;; Calculate a video-memory location for drawing the entity
   419A 11 00 C0      [10]  157    ld   de, #CPCT_VMEM_START_ASM    ;; DE = Pointer to start of the screen
   419D DD 46 04      [19]  158    ld   b, e_py(ix)                      ;; B = y coordinate 
   41A0 DD 4E 03      [19]  159    ld   c, e_px(ix)                      ;; C = x coordinate 
   41A3 CD 63 43      [17]  160    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            161    ;; Draw Sprite
   41A6 EB            [ 4]  162    ex  de, hl                       ;; DE = Pointer to Video Memory (X,Y) location
   41A7 DD 66 08      [19]  163    ld   h, e_sprite + 1(ix)    ;; | HL = Pointer to Player Sprite
   41AA DD 6E 07      [19]  164    ld   l, e_sprite + 0(ix)    ;; |
   41AD DD 46 05      [19]  165    ld   b, e_width(ix)         ;; B = Player Width (bytes)
   41B0 DD 4E 06      [19]  166    ld   c, e_height(ix)        ;; C = Player Height (pixels)
   41B3 CD 3B 43      [17]  167    call cpct_drawSpriteBlended_asm         ;; Draw the sprite
                            168    
                            169    
                            170    ;; Update previous coordinates
   41B6 DD 7E 01      [19]  171    ld a, e_x(ix)
   41B9 DD 77 03      [19]  172    ld e_px(ix), a 
   41BC DD 7E 02      [19]  173    ld a, e_y(ix)
   41BF DD 77 04      [19]  174    ld e_py(ix), a 
                            175    
                            176    
...
Hexadecimal [16-Bits]
                            ...
                            177    ;; Draw Sprite
                            178    ;; Calculate a video-memory location for drawing the entity
   41C2 11 00 C0      [10]  179    ld   de, #CPCT_VMEM_START_ASM    ;; DE = Pointer to start of the screen
   41C5 DD 46 02      [19]  180    ld   b, e_y(ix)                      ;; B = y coordinate 
   41C8 DD 4E 01      [19]  181    ld   c, e_x(ix)                      ;; C = x coordinate 
   41CB CD 63 43      [17]  182    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            183    ;; Draw Sprite
   41CE EB            [ 4]  184    ex  de, hl                       ;; DE = Pointer to Video Memory (X,Y) location
   41CF DD 66 08      [19]  185    ld   h, e_sprite + 1(ix)    ;; | HL = Pointer to Player Sprite
   41D2 DD 6E 07      [19]  186    ld   l, e_sprite + 0(ix)    ;; |
   41D5 DD 46 05      [19]  187    ld   b, e_width(ix)         ;; B = Player Width (bytes)
   41D8 DD 4E 06      [19]  188    ld   c, e_height(ix)        ;; C = Player Height (pixels)
   41DB CD 3B 43      [17]  189    call cpct_drawSpriteBlended_asm         ;; Draw the sprite
                            190    
                            191    ;; Update status
   41DE DD 7E 00      [19]  192    ld a, e_status(ix)
   41E1 E6 7F         [ 7]  193    and #0b01111111
   41E3 DD 77 00      [19]  194    ld e_status(ix),a
   41E6 C9            [10]  195 ret
                            196 
                            197 ;;
                            198 ;; define board a matrix of 19x8 bytes
                            199 ;;
   41E7 08                  200 board_width: .db 8
   41E8 13                  201 board_height: .db 19
   41E9                     202 board1:
   41E9 00 00 00 00 00 00   203     .db 0,0,0,0,0,0,0,0
        00 00
   41F1 00 00 00 00 00 00   204     .db 0,0,0,0,0,0,0,0
        00 00
   41F9 00 00 00 00 00 00   205     .db 0,0,0,0,0,0,0,0
        00 00
   4201 00 00 00 00 00 00   206     .db 0,0,0,0,0,0,0,0
        00 00
   4209 00 00 00 00 00 00   207     .db 0,0,0,0,0,0,0,0
        00 00
   4211 00 00 00 00 00 00   208     .db 0,0,0,0,0,0,0,0
        00 00
   4219 00 00 00 00 00 00   209     .db 0,0,0,0,0,0,0,0
        00 00
   4221 00 00 00 00 00 00   210     .db 0,0,0,0,0,0,0,0
        00 00
   4229 00 00 00 00 00 00   211     .db 0,0,0,0,0,0,0,0
        00 00
   4231 00 00 00 00 00 00   212     .db 0,0,0,0,0,0,0,0
        00 00
   4239 00 00 00 00 00 00   213     .db 0,0,0,0,0,0,0,0
        00 00
   4241 00 00 00 00 00 00   214     .db 0,0,0,0,0,0,0,0
        00 00
   4249 00 00 00 00 00 00   215     .db 0,0,0,0,0,0,0,0
        00 00
   4251 00 00 00 00 00 00   216     .db 0,0,0,0,0,0,0,0
        00 00
   4259 00 00 00 00 00 00   217     .db 0,0,0,0,0,0,0,0
...
Hexadecimal [16-Bits]
        ...
        00 00
   4261 00 00 00 00 00 00   218     .db 0,0,0,0,0,0,0,0
        00 00
   4269 00 00 00 00 00 00   219     .db 0,0,0,0,0,0,0,0
        00 00
   4271 00 00 00 00 00 00   220     .db 0,0,0,0,0,0,0,0
        00 00
   4279 00 00 00 00 00 00   221     .db 0,0,0,0,0,0,0,0
        00 00
                            222 
                            223 ;;  DrawBoard
                            224 ;;  
                            225 ;;
   4281                     226 _draw_board:
                            227 
   4281 C9            [10]  228 ret
                            229 
                            230 
   ...
   4282                     236 _init_main:
                            237  ;; Set Palette
   4282 21 FC 40      [10]  238    ld    hl, #_sp_palette           ;; HL = pointer to the start of the palette array
   4285 11 10 00      [10]  239    ld    de, #palette_size           ;; DE = Size of the palette array (num of colours)
   4288 CD E7 42      [17]  240    call  cpct_setPalette_asm        ;; Set the new palette
                            241 
   428B 0E 00         [ 7]  242     ld  c, #0                     ;; C = 0 (Mode 0)
   428D CD 04 43      [17]  243     call cpct_setVideoMode_asm    ;; Set Mode 0
                            244 
                            245 
                            246 
   4290 26 00         [ 7]  247     ld h, #0                ;; left pixel color
   4292 2E 00         [ 7]  248     ld l, #0                ;; right pixel color 
   4294 CD 11 43      [17]  249     call cpct_px2byteM0_asm
                            250 
   4297 21 00 C0      [10]  251     ld hl, #CPCT_VMEM_START_ASM
   429A 77            [ 7]  252     ld (hl), a         ;; color definido antes 
   429B 11 01 C0      [10]  253     ld de, #0xc001
   429E 01 00 40      [10]  254     ld bc, #0x4000
   42A1 ED B0         [21]  255     ldir
   42A3 C9            [10]  256     ret 
                            257 
                            258 ;;
                            259 ;; MAIN function. This is the entry point of the application.
                            260 ;;    _main:: global symbol is required for correctly compiling and linking
                            261 ;;
   42A4                     262 _main::
                            263     ;; Disable firmware to prevent it from interfering with string drawing
   42A4 CD 2B 43      [17]  264     call cpct_disableFirmware_asm
                            265     ;; Call to de main initialization
   42A7 CD 82 42      [17]  266     call _init_main
                            267     ;; First sprite draw
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   42AA DD 21 4B 41   [14]  268     ld ix, #player
   42AE CD 7D 41      [17]  269     call _draw_entity
                            270   
                            271 ;; Main loop
   42B1                     272 main_loop:
   42B1 CD 7F 43      [17]  273     call cpct_scanKeyboard_asm  ;; Reads keyboard
                            274     
                            275     ;; Check right movement
   42B4 21 03 08      [10]  276     ld hl, #Key_P               
   42B7 CD DB 42      [17]  277     call cpct_isKeyPressed_asm
   42BA B7            [ 4]  278     or a
   42BB CA C1 42      [10]  279     jp z, no_right
   42BE CD 54 41      [17]  280     call _move_entity_right
   42C1                     281 no_right:
                            282 
                            283 ;; Check left movement
   42C1 21 04 04      [10]  284     ld hl, #Key_O               
   42C4 CD DB 42      [17]  285     call cpct_isKeyPressed_asm
   42C7 B7            [ 4]  286     or a
   42C8 CA CE 42      [10]  287     jp z, no_left
   42CB CD 69 41      [17]  288     call _move_entity_left
   42CE                     289 no_left:
                            290 
   42CE DD 7E 00      [19]  291     ld a, e_status(ix)
   42D1 E6 80         [ 7]  292     and #0b10000000
   42D3 CA D9 42      [10]  293     jp z, no_update
   42D6 CD 9A 41      [17]  294     call _update_entity
   42D9                     295  no_update:
   42D9 18 D6         [12]  296     jr    main_loop
